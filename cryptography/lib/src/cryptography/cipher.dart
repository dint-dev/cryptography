...
abstract class Cipher {
  ...
  /// Mac algorithm used by the cipher.
  MacAlgorithm get macAlgorithm;

  /// Number of bytes in the [Nonce] generated by [newNonce].
  int get nonceLength;
  ...
  /// Authenticates and decrypts the message.
  ///
  ...
  /// Encrypts a message and calculates [Mac].
  ///
  /// You must give a [SecretKey] that has the correct length and type.
  ///
  /// Optional parameter `nonce` (also known as "initialization vector",
  ...
  /// Generates a random nonce. The length is [nonceLength].
  List<int> newNonce() {
  ...
  /// Generates a random [SecretKey]. The length is [secretKeyLength].
  ...
  ///
  /// The implementation may return an optimized subclass of [SecretKey].
