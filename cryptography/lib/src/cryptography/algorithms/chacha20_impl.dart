...
@visibleForTesting
class Chacha20 extends _SyncKeyStreamCipher {
  const Chacha20();
  ...
  SyncKeyStreamCipherState newState({
    ...
    final state = Chacha20State(this);
    state.initialize(
...
@visibleForTesting
class Chacha20State extends SyncKeyStreamCipherState {
